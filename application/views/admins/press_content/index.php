...
<!--				<th>Category</th>-->
			...
			<?php foreach ($press as $data) : ?>
				<tr>
                    ...
                    <td><img src="<?php echo $this->main->image_preview_url($data->thumbnail) ?>" width="<?php echo $this->main->image_size_preview() ?>" class="img-thumbnail"></td>
                    <td><a href="<?php echo $data->url ?>">Go to Website</a></td>
...
<form method="post" action="<?php echo base_url() . 'proweb/press_content/createprocess'; ?>" enctype="multipart/form-data"
	  class="form-send">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Add Press</h5>
...
<!--					</div>-->
					...
					<div class="form-group">
						<label for="exampleSelect1">URL Website</label>
						<input type="text" class="form-control" placeholder="URL Website" name="url">
					</div>
				</div>
...
<form method="post" action="<?php echo base_url() . 'proweb/press_content/update'; ?>" enctype="multipart/form-data"
	  class="form-send">
	...
	<div class="modal" id="modal-edit" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Edit Press</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					</button>
				</div>
				<div class="modal-body">
