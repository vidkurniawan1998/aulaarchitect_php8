...
<form method="post" action="<?php echo base_url().'proweb/gallery_photo/createprocess' ;?>" enctype="multipart/form-data" class="form-send" >
...
<form method="post" action="<?php echo base_url().'proweb/gallery_photo/update' ; ?>" enctype="multipart/form-data" class="form-send" >
