					...
					<ul class="kt-menu__nav ">
						<?php foreach ($menu_list as $key => $val) { ?>
							...
							<?php foreach ($val as $key1 => $val1) {
								...
								$target_blank = '';
								if($val1['label'] == 'View Website') {
								    $target_blank = 'target="_blank"';
                                }

								?>
								<li class="kt-menu__item  kt-menu__item--submenu <?php echo $menu_active ?>" aria-haspopup="true"
									data-ktmenu-submenu-toggle="hover">
									<a href="<?php echo $val1['route'] ?>" <?php echo $target_blank ?> class="kt-menu__link <?php echo $sub_menu ? 'kt-menu__toggle': '' ?>">
										...
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
													class="kt-menu__link"><span
														class="kt-menu__link-text"><?php echo $val1['label'] ?></span></span>
											</li>
											<?php foreach ($val1['sub_menu'] as $key2 => $val2) {
												...
												?>
												<li class="kt-menu__item <?php echo $menu_sub_active ?>" aria-haspopup="true"><a
														href="<?php echo $val2['route'] ?>" class="kt-menu__link "><i
															class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
															class="kt-menu__link-text"><?php echo $val2['label'] ?></span></a>
												</li>
											<?php } ?>
										</ul>
									</div>
...
<!--								</div>-->
			...
			<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
				<div class="kt-footer__copyright">
					2013 - <?php echo date('Y') ?>&nbsp;&copy;&nbsp;<a href="https://proweb.com" target="_blank" class="kt-link">proweb</a>
				</div>
			</div>
