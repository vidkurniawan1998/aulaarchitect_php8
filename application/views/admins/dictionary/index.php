<form class="form-send" method="post" action="<?php echo base_url('proweb/dictionary/update') ?>">
    ...
    <button type="submit" style="position: fixed; left: 50%; z-index: 100000; bottom: 30px" class="btn btn-success btn-elevate btn-pill btn-elevate-air btn-lg">Simpan</button>
</form>