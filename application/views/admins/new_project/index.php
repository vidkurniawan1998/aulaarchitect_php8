...
<!--				<th>Category</th>-->
			...
			<?php $no = 1 ?>
			<tbody>
			<?php foreach ($new_project as $datas) : ?>
				<tr>
...
<!--					<td>--><?php //echo $datas->blog_category_title ?><!--</td>-->
					...
					<td>
						...
						<a href="#"
						   data-action="<?php echo base_url() ?>proweb/new_project/delete/<?php echo $datas->id ?>"
...
<form method="post" action="<?php echo base_url() . 'proweb/new_project/createprocess'; ?>" enctype="multipart/form-data"
	  class="form-send">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Add On Going Project</h5>
...
<form method="post" action="<?php echo base_url() . 'proweb/new_project/update'; ?>" enctype="multipart/form-data"
	  class="form-send">
	...
	<div class="modal" id="modal-edit" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Edit On Going Project</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					</button>
				</div>
				<div class="modal-body">
